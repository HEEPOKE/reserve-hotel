...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/reportreserve.css') }}">
    <link rel="stylesheet" href="{{ asset('css/allchart_report.css') }}">
    <link rel="stylesheet" href="{{ asset('css/dashboard_company.css') }}">
    <link rel="stylesheet" href="{{ asset('css/dashboard_provider.css') }}">
    <link rel="stylesheet" href="{{ asset('css/image-uploader.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/calender/main.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/calender/main.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/logmodal-xl.css') }}">
...
<body class="@yield('classes_body')" @yield('body_data')>
    ...
    <script src="{{ asset('js/smart_card.js') }}"></script>
