    <div class="card poChart mt-3">
        <div class="card-header bgtable">
            <h3 class="card-title text-white"><strong>รายงานผู้สมัครใช้งานใหม่เเบบรายวันเเละรายเดือน ปี
                    {{ $id ?? '' }}</strong></h3>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header card-header bg-primary border-primary">
                                        <h5 class="modal-title" id="viewstatusModalLabel">ดูรายละเอียดผู้ประกอบการ
                                        </h5>
